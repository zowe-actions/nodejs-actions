...
const Debug = __nccwpck_require__(9867)
...
module.exports = __nccwpck_require__(4653)(exports);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
	module.exports = __nccwpck_require__(9814);
} else {
	module.exports = __nccwpck_require__(7899);
}
